...
export class CustomToggleComponent {
  ...
  // Customizable styles
  @Input() toggleSwitchBgColor: string = '#e0e0e0'; // Default light gray
  @Input() toggleKnobBgColor: string = 'white';
  @Input() toggleOutlineColor: string = '#ccc';

  @Input() toggleSwitchWidth: string = '40px';
  @Input() toggleSwitchHeight: string = '20px';

  @Input() toggleKnobWidth: string = '18px';
  @Input() toggleKnobHeight: string = '18px';
